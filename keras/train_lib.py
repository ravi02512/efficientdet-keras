...
class StepwiseLrSchedule(tf.keras.optimizers.schedules.LearningRateSchedule):
...
class PolynomialLrSchedule(tf.keras.optimizers.schedules.LearningRateSchedule):
